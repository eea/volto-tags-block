...
### [4.0.1](https://github.com/eea/volto-tags-block/compare/4.0.0...4.0.1) - 8 April 2026

#### :hammer_and_wrench: Others

- test: Fix make test [Alin V. (Claudiu) - [`01a1c32`](https://github.com/eea/volto-tags-block/commit/01a1c32d8dd03835c46092eb56526b7d311a086a)]
## [4.0.0](https://github.com/eea/volto-tags-block/compare/3.0.1...4.0.0) - 25 March 2026

#### :rocket: New Features

- feat: Volto 18 support - refs #287700 [Alin Voinea - [`8f1ea90`](https://github.com/eea/volto-tags-block/commit/8f1ea907f90c7f3afc0b38dcdfb1fbe510d8e242)]

#### :house: Internal changes

- chore: [JENKINSFILE] add package version in sonarqube [valentinab25 - [`0997783`](https://github.com/eea/volto-tags-block/commit/0997783694a999d908e90d95eb2702933cf6eb5d)]
- chore: [JENKINSFILE] use sonarqube branches [EEA Jenkins - [`1114706`](https://github.com/eea/volto-tags-block/commit/1114706a9203b4b3cb948ca0d0ec9e4b5a7bcd36)]

#### :hammer_and_wrench: Others

- tests: Fix Sonar Qube tags - refs #297339 [Alin Voinea - [`2cd419e`](https://github.com/eea/volto-tags-block/commit/2cd419eb6924063c82cfcba6b9e3e9a1e950d5b8)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`a80409a`](https://github.com/eea/volto-tags-block/commit/a80409aae452929e30b48bc300cf4b2d92e78785)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`f0cfb6a`](https://github.com/eea/volto-tags-block/commit/f0cfb6abea8885696590919a26fa542ea091e140)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`cc671b6`](https://github.com/eea/volto-tags-block/commit/cc671b6e33bc5ac0c615af992fe4397625252ccf)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`3c11b7c`](https://github.com/eea/volto-tags-block/commit/3c11b7c0cca47937b04241779a1b992385693613)]
- Add Sonarqube tag using ied-frontend addons list [EEA Jenkins - [`d6070c3`](https://github.com/eea/volto-tags-block/commit/d6070c332603c426d00fff16386487e7dae1b7a6)]
### [3.0.1](https://github.com/eea/volto-tags-block/compare/3.0.0...3.0.1) - 30 January 2025
...
- chore: [JENKINS] Refactor automated testing [valentinab25 - [`b9f8763`](https://github.com/eea/volto-tags-block/commit/b9f87634ed2756edd907f9305b8165cada249f90)]

#### :hammer_and_wrench: Others

- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`2ebca21`](https://github.com/eea/volto-tags-block/commit/2ebca21c24bb9c86d262eab2556ae3a3e22bbe43)]
- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`50438c6`](https://github.com/eea/volto-tags-block/commit/50438c6d90e0fd97df9a00ed0f35145836fdc8d2)]
- test: [JENKINS] Use java17 for sonarqube scanner [valentinab25 - [`1502bbe`](https://github.com/eea/volto-tags-block/commit/1502bbecda49064407d86610758bae05fbe97605)]
- test: [JENKINS] Run cypress in started frontend container [valentinab25 - [`1f231ab`](https://github.com/eea/volto-tags-block/commit/1f231ab4cf8d7b3e8df918439035e4c1136b7154)]
- test: [JENKINS] Add cpu limit on cypress docker [valentinab25 - [`9a5ac19`](https://github.com/eea/volto-tags-block/commit/9a5ac1984d14faae578cd17c5d76977198a38ebd)]
- test: [JENKINS] Increase shm-size to cypress docker [valentinab25 - [`a8e063b`](https://github.com/eea/volto-tags-block/commit/a8e063b1db3ec58a79a25bbeaf095dc81eb1b217)]
- test: [JENKINS] Improve cypress time [valentinab25 - [`01f5d48`](https://github.com/eea/volto-tags-block/commit/01f5d486bbcfc03c7495755e33edc41c334cb175)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`2df7cbb`](https://github.com/eea/volto-tags-block/commit/2df7cbb44f8101f667f8641dfb621b8a54c554cf)]
